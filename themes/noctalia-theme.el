...
(let* ((bg "#111318")
      ...
      (tertiary "#dbbce1")
      (tertiary-container "#563e5d")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#dbbce1")
      (on-success "#3e2845")
      (success-container "#563e5d")
      (on-success-container "#f8d8fe")
      ;; Map fixed colors to regular colors
      (primary-fixed "#a8c8ff")
      (primary-fixed-dim "#254777")
      (secondary-fixed "#bdc7dc")
      (secondary-fixed-dim "#3e4758")
      (tertiary-fixed "#dbbce1")
      (tertiary-fixed-dim "#563e5d")
      (on-primary-fixed "#06305f")
      (on-primary-fixed-variant "#d6e3ff")
      (on-secondary-fixed "#273141")
      (on-secondary-fixed-variant "#d9e3f8")
      (on-tertiary-fixed "#3e2845")
      (on-tertiary-fixed-variant "#f8d8fe")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e1e2e9")

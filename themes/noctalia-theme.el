...
(let* ((bg "#0e1513")
      ...
      (on-primary "#00382e")
      (on-primary-container "#a0f2de")
      (on-secondary "#1d352f")
      (on-secondary-container "#cde8e0")
      (on-surface "#dee4e0")
      (on-surface-variant "#bfc9c4")
      (on-tertiary "#113348")
      (on-tertiary-container "#c8e6ff")
      (outline-color "#89938f")
      ...
      (tertiary "#aacbe4")
      (tertiary-container "#2a4a5f")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#aacbe4")
      (on-success "#113348")
      (success-container "#2a4a5f")
      (on-success-container "#c8e6ff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#84d6c2")
      (primary-fixed-dim "#005144")
      (secondary-fixed "#b1ccc4")
      (secondary-fixed-dim "#334b45")
      (tertiary-fixed "#aacbe4")
      (tertiary-fixed-dim "#2a4a5f")
      (on-primary-fixed "#00382e")
      (on-primary-fixed-variant "#a0f2de")
      (on-secondary-fixed "#1d352f")
      (on-secondary-fixed-variant "#cde8e0")
      (on-tertiary-fixed "#113348")
      (on-tertiary-fixed-variant "#c8e6ff")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#dee4e0")
      (inverse-primary "#84d6c2")
      (inverse-surface "#0e1513")

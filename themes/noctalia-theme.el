...
(let* ((bg "#171213")
      ...
      (primary "#ffb1c2")
      (primary-container "#7c2942")
      (secondary "#e4bdc4")
      (secondary-container "#5b3f45")
      (shadow "#000000")
      (surface "#171213")
      ...
      (tertiary "#ecbe91")
      (tertiary-container "#60401e")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#ecbe91")
      (on-success "#462a09")
      (success-container "#60401e")
      (on-success-container "#ffdcbd")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ffb1c2")
      (primary-fixed-dim "#7c2942")
      (secondary-fixed "#e4bdc4")
      (secondary-fixed-dim "#5b3f45")
      (tertiary-fixed "#ecbe91")
      (tertiary-fixed-dim "#60401e")
      (on-primary-fixed "#5f112c")
      (on-primary-fixed-variant "#ffd9e0")
      (on-secondary-fixed "#43292f")
      (on-secondary-fixed-variant "#ffd9e0")
      (on-tertiary-fixed "#462a09")
      (on-tertiary-fixed-variant "#ffdcbd")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#ece0e1")
      (inverse-primary "#ffb1c2")
      (inverse-surface "#171213")

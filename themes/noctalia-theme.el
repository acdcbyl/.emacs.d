...
(let* ((bg "#131316")
      ...
      (tertiary "#e2bbdb")
      (tertiary-container "#5b3d58")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#e2bbdb")
      (on-success "#422740")
      (success-container "#5b3d58")
      (on-success-container "#ffd6f8")
      ;; Map fixed colors to regular colors
      (primary-fixed "#b4c5ff")
      (primary-fixed-dim "#234290")
      (secondary-fixed "#c1c5dd")
      (secondary-fixed-dim "#414659")
      (tertiary-fixed "#e2bbdb")
      (tertiary-fixed-dim "#5b3d58")
      (on-primary-fixed "#002a78")
      (on-primary-fixed-variant "#dbe1ff")
      (on-secondary-fixed "#2b3042")
      (on-secondary-fixed-variant "#dde1f9")
      (on-tertiary-fixed "#422740")
      (on-tertiary-fixed-variant "#ffd6f8")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e4e2e6")

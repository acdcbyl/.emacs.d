...
(let* ((bg "#161217")
      ...
      (on-primary "#432255")
      (on-primary-container "#f6d9ff")
      (on-secondary "#382c3e")
      (on-secondary-container "#f0dcf4")
      (on-surface "#e9e0e7")
      (on-surface-variant "#cec3ce")
      (on-tertiary "#4c2526")
      (on-tertiary-container "#ffdad9")
      (outline-color "#978e98")
      (outline-variant "#4b444d")
      (primary "#e2b7f4")
      (primary-container "#5b396d")
      (secondary "#d3c0d8")
      (secondary-container "#504255")
      (shadow "#000000")
      (surface "#161217")
      ...
      (surface-container-lowest "#110d12")
      (surface-variant "#4b444d")
      (tertiary "#f4b7b7")
      (tertiary-container "#663b3b")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#f4b7b7")
      (on-success "#4c2526")
      (success-container "#663b3b")
      (on-success-container "#ffdad9")
      ;; Map fixed colors to regular colors
      (primary-fixed "#e2b7f4")
      (primary-fixed-dim "#5b396d")
      (secondary-fixed "#d3c0d8")
      (secondary-fixed-dim "#504255")
      (tertiary-fixed "#f4b7b7")
      (tertiary-fixed-dim "#663b3b")
      (on-primary-fixed "#432255")
      (on-primary-fixed-variant "#f6d9ff")
      (on-secondary-fixed "#382c3e")
      (on-secondary-fixed-variant "#f0dcf4")
      (on-tertiary-fixed "#4c2526")
      (on-tertiary-fixed-variant "#ffdad9")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e9e0e7")
      (inverse-primary "#e2b7f4")
      (inverse-surface "#161217")

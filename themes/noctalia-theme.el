...
(let* ((bg "#12140e")
      ...
      (outline-color "#8e9285")
      (outline-variant "#44483d")
      (primary "#b1d18a")
      (primary-container "#344e16")
      (secondary "#bfcbad")
      ...
      (success "#a0d0cc")
      (on-success "#003735")
      (success-container "#1f4e4b")
      (on-success-container "#bbece8")
      ;; Map fixed colors to regular colors
      (primary-fixed "#b1d18a")
      (primary-fixed-dim "#344e16")
      (secondary-fixed "#bfcbad")
      (secondary-fixed-dim "#404a33")
      (tertiary-fixed "#a0d0cc")
      (tertiary-fixed-dim "#1f4e4b")
      (on-primary-fixed "#1f3701")
      (on-primary-fixed-variant "#cceda4")
      (on-secondary-fixed "#2a331e")
      (on-secondary-fixed-variant "#dbe7c8")
      (on-tertiary-fixed "#003735")
      (on-tertiary-fixed-variant "#bbece8")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e2e3d8")
      (inverse-primary "#b1d18a")
      (inverse-surface "#12140e")

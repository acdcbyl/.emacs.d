...
;; add mpd client
(load-file (expand-file-name "extras/mpd.el" user-emacs-directory))
...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("1332d632ed6bbca9c285f03cc3128f01402653c0fe2779bc7ce176fc1ee51c2a"
     default))
 '(doom-modeline-check-simple-format t nil nil "Customized with use-package doom-modeline")
 '(package-selected-packages
   '(avy cape catppuccin catppuccin-theme colorful-mode corfu-terminal
	 dashboard doom-modeline embark-consult emms evil-args
	 evil-collection evil-escape evil-surround general go-mode
	 good-scroll json-mode lyrics-fetcher magit marginalia
	 nerd-icons-completion nerd-icons-corfu nerd-icons-dired
	 no-littering orderless org-modern org-roam projectile
	 rainbow-delimiters rust-mode treemacs treemacs-evil
	 treemacs-icons-dired vertico wgrep yaml-mode)))
(custom-set-faces

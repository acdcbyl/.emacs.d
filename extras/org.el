...
(use-package org-modern
  ...
  :config
  (setq org-modern-star 'replace)          ; 替换星号为更美观的符号
  (setq org-modern-table-vertical 1)       ; 表格竖线
  (setq org-modern-table-horizontal 0.2)   ; 表格横线
  (setq org-modern-list '((43 . "➤")       ; + 号列表
                          (45 . "–")       ; - 号列表
                          (42 . "•")))     ; * 号列表
  (setq org-modern-block-fringe nil)       ; 代码块边框
